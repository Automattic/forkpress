...
| `forkpress remote clone <name> --ssh <host> --path <wp-root> --branch <branch>` | Thin-clone a remote WordPress root over SSH, skipping uploads by default, and create a local COW branch. |
