...
For filesystem merge behavior, including binary changes, safe relative
symlinks, directory/file type replacement review, source directory deletes with
target descendants, and unsafe symlink conflicts, run:
