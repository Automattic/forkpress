...
attachments/files and `core/image`/`core/gallery` block JSON left pointing at deleted
attachments/files, `core/query` block JSON left pointing at deleted author
users or taxonomy terms, term relationships left pointing at deleted taxonomy terms,
