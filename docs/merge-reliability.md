...
For WordPress upload/media validator changes, including missing original,
metadata-side original, or generated upload files, invalid serialized attachment
...
filename drift, unsafe primary/metadata/generated paths, and malformed or
...
deleted reusable blocks or synced patterns and nav menu items left pointing at
deleted pages, plus featured-image postmeta left pointing at deleted
attachments/files and `core/image` block JSON left pointing at deleted
attachments/files, term relationships left pointing at deleted taxonomy terms,
comments left pointing at deleted posts/users/parent comments, commentmeta
