...
at deleted WordPress objects, and the built-in WordPress page-route validator
that holds duplicate route-visible page slugs under the same parent, run:
