...
Recent additions on the current reliability branch:
...
- Keep aarch64 macOS release artifacts and APFS sparsebundle E2E runs green for
  each release. `v0.1.30` is the current published release after the Apple
  Silicon production-bundle gate stayed green and the current reliability
  slices through trunk commit `cec842789ab8f5d1f255f9c560dcd6bfb8e86dbf`
  were released.
