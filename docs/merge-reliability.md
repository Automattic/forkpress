...
page-plus-taxonomy, page-plus-menu, and page-plus-options cases must complete
with zero conflicts while preserving branch-specific IDs inside menu
relationships, theme-mod locations, JSON payloads, and serialized payloads
without rewrite.
