...
page-plus-image-block, page-plus-gallery, and page-plus-options cases must
complete with zero conflicts while preserving
...
metadata, `core/image`/`core/gallery` block JSON, upload files, JSON payloads,
