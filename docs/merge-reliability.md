...
- Keep aarch64 macOS release artifacts and APFS sparsebundle E2E runs green for
  each release. `v0.1.21` is the current published release after the Apple
  Silicon production-bundle gate was restored.
