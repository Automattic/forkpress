...
It also includes an attachment edit/delete conflict case that must stay
reviewable and keep the target deletion until review covers the DB and file
graph.
