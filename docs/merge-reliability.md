...
page-plus-image-block, and page-plus-options cases must complete with zero
conflicts while preserving
...
metadata, `core/image` block JSON, upload files, JSON payloads, and serialized
payloads without rewrite.
