...
page-plus-taxonomy, page-plus-menu, page-plus-reusable-block, and
page-plus-options cases must complete with zero conflicts while preserving
branch-specific IDs inside menu relationships, theme-mod locations,
reusable-block comments, JSON payloads, and serialized payloads without rewrite.
