...
original/generated upload ownership, attached-file metadata drift, unsafe
...
For plugin-owned DB/JSON/file graph validator changes, including validator
runner contract checks and rerun replacement evidence, run:
