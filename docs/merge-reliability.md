...
Recent additions released in `v0.1.31`:
...
- Keep aarch64 macOS release artifacts and APFS sparsebundle E2E runs green for
  each release. `v0.1.31` is the current published release after all five
  production-bundle targets stayed green and the current reliability slices
  through trunk commit `4a6f53857af4d31a634ed97b65bb878bcb1dc89c` were
  released.
