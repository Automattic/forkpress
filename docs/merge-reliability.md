...
For schema dependency planning and review-only cases such as cyclic
source-added views/triggers or source-added triggers with missing dependencies,
run:
