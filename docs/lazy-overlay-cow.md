...
- Windows supports the native materialized COW tier when the project lives on a
  ReFS/Dev Drive volume. The remaining product gap is installer integration and
  a native lazy branch namespace such as ProjFS.
