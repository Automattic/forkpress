...
if (is_resource($lock)) {
    ...
    if (is_resource($process)) {
        ...
        assert_true(str_contains($early_body, 'needs review'), 'out-of-band branch manager labels graph conflicts as review work');
        ...
        assert_true(str_contains($early_body, 'merged; review needed'), 'out-of-band branch manager avoids implying conflicted merges are value-less');
        ...
        assert_true(str_contains($early_body, 'function forgetConflictCache'), 'out-of-band branch manager invalidates cached conflict records after review actions');
        assert_true(str_contains($early_body, 'function refreshAfterConflictAction'), 'out-of-band branch manager refreshes graph and conflict data after review actions');
        ...
        assert_true(str_contains($early_body, 'need review'), 'out-of-band branch manager describes pending conflict checks as review work');
        ...
        assert_true(str_contains($early_body, 'function conflictReviewAccepted'), 'out-of-band branch manager names accepted review state without overloading merge resolution');
        ...
        assert_true(str_contains($early_body, 'Needs review'), 'out-of-band branch manager labels the pending filter by review state');
