...
PHP);
    ...
    assert_same(count($unsafe_audit['conflicts']), 8, 'media validator exposes unsafe primary, URL, drive, metadata, generated, original_image, and backup upload paths as plugin-scoped audit conflicts');
