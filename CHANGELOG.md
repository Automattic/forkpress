...
- Added `forkpress branch merge-resolve conflict <id> --choice source|target` as the first validation-gated deterministic resolver for explicit-PK DB cell conflicts and row insert collisions, with applied resolutions recorded in merge metadata.
