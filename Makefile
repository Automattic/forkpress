...
test-cow-e2e-git-existing-update-crash:
	FORKPRESS_E2E_ONLY=git-existing-update-crash $(COW_TEST_DIR)/e2e.sh $(FORKPRESS_E2E_BIN)
...
test-cow-semantic-fast: test-cow-merge-smoke
	php $(COW_TEST_DIR)/explicit_ids.php
	php $(COW_TEST_DIR)/id_bands.php
	php $(COW_TEST_DIR)/media_validator.php
	php $(COW_TEST_DIR)/plugin_validator.php
